...
\end{frame}
	...
	\begin{minipage}[h]{0.6\linewidth}
		...
		Donc : M1 = M0 +1 C = [1, 1, 0, 4] + [0,0 ,1 ,-1] =[1,1,1,3] etc.\\
		Le graphe des marquages accessibles :
	\end{minipage}
	\end{frame}
	...
	\end{frame}
		...
		\begin{frame}
			...
			\begin{center}
				\includegraphics<1>[scale=0.35]{exemple\_page10_3.png}
			\end{center}
		\end{frame}
	...
	\begin{frame}
		...
		\begin{examplesecond}{Définition}
			Un RdP admet un état d’accueil $M_{a}$ si :$ \forall M \in A, \exists \sigma \in T ∗ /M [ \sigma > M_{a}$.\\
